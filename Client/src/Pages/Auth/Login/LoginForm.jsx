...
const LoginForm = ({handleSubmit,handleChange, form}) => {
  return (
        ...
        <div className="flex justify-center items-center w-screen h-screen bg-white overflow-hidden">
            ...
            <div className="circle w-[800px] h-[800px] flex-shrink-0 rounded-[50%] flex justify-center items-center">
                ...
                <div className="container bg-white w-[50%] max-w-lg rounded-lg  p-6 sm:p-8">
                    <form onSubmit={(e) => handleSubmit(e, 'login')} method='POST' className="text-gray-400 w-[100%] mb-4">
                        <div className="flex flex-col">
                            <span className="title italic text-center font-bold text-2xl sm:text-2xl">Login</span>
