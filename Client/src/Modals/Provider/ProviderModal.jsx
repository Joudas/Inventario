    ...
    transform -translate-x-1/2 -translate-y-1 flex items-center justify-center ">
      <div className="w-full h-full relative flex items-center justify-center ">
        ...
        <form action="" onSubmit={isUpdate ? props.handleSubmitUpdate : props.handleSubmit} className="flex flex-col create-product w-[80%] justify-normal">
          ...
          <div className="">
            <label className="block text-sm font-medium text-gray-700 mt-2" htmlFor="phone">Número</label>
            <input value={props.form.phone} className="mt-1 block px-4 py-2 w-full
            bg-gray-50 border border-gray-300 rounded-md shadow-sm focus:outline-none sm:text-sm" type="text" id="phone" name="phone" onChange={props.handleChange}/>
            <label className="block text-sm font-medium text-gray-700 mt-2" htmlFor="email">Correo</label>
            <input value={props.form.email} className="mt-1 block px-4 py-2 w-full
            bg-gray-50 border border-gray-300 rounded-md shadow-sm focus:outline-none sm:text-sm" type="email" id="email" name="email" onChange={props.handleChange}/>
          </div>
          <div className="">
